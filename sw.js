const C='controlo-horas-v3-10-6-total-receber-corrigido';
const A=['./','./index.html','./styles.css','./app.js?v=3.10.6','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

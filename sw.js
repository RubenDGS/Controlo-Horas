const C='controlo-horas-v3-15-2-quilometros-automaticos';
const A=['./','./index.html','./styles.css','./app.js?v=3.15.2','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

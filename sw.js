const C='controlo-horas-v3-13-3-alojamento-manual';
const A=['./','./index.html','./styles.css','./app.js?v=3.13.3','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

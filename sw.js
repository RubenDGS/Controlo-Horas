const C='controlo-horas-v3-9-2-nome-poupanca-anual';
const A=['./','./index.html','./styles.css','./app.js?v=3.9.2','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

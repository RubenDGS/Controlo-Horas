const C='controlo-horas-v3-11-5-total-receber-3a-coluna';
const A=['./','./index.html','./styles.css','./app.js?v=3.11.5','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

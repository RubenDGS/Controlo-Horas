const C='controlo-horas-v3-12-5-verificacao-integridade';
const A=['./','./index.html','./styles.css','./app.js?v=3.12.5','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

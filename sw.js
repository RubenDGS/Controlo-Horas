const C='controlo-horas-v3-12-4-duplicados-inteligentes';
const A=['./','./index.html','./styles.css','./app.js?v=3.12.4','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

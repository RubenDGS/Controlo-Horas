const C='controlo-horas-v3-15-3-quilometros-corrigidos';
const A=['./','./index.html','./styles.css','./app.js?v=3.15.3','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

const C='controlo-horas-v3-11-9-subsidio-refeicao-corrigido';
const A=['./','./index.html','./styles.css','./app.js?v=3.11.9','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

const C='controlo-horas-v3-9-5-backup-completo';
const A=['./','./index.html','./styles.css','./app.js?v=3.9.5','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

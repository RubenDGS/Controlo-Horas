const C='controlo-horas-v3-11-8-arredondamento-irs';
const A=['./','./index.html','./styles.css','./app.js?v=3.11.8','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

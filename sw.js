const C='controlo-horas-v3-11-4-leitura-posicional-real';
const A=['./','./index.html','./styles.css','./app.js?v=3.11.4','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

const C='controlo-horas-v3-8-4-estado-civil-dependentes';
const A=['./','./index.html','./styles.css','./app.js?v=3.8.4','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

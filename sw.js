const C='controlo-horas-v3-15-1-feriados-portugal';
const A=['./','./index.html','./styles.css','./app.js?v=3.15.1','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

const C='controlo-horas-v3-8-9-partilha-nome-visivel';
const A=['./','./index.html','./styles.css','./app.js?v=3.8.9','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];

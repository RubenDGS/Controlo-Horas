const C='controlo-horas-v3-9-7-backup-partilha-corrigida';
const A=['./','./index.html','./styles.css','./app.js?v=3.9.7','./manifest.webmanifest','./logotipo.png','./icon-192.png','./icon-512.png','./locations.json'];
